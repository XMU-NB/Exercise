...
public class TwoLinkedListsIntersection {
    ...
    //如果只是判断有没有交点,判断最后一个节点是否相同，
    // 或者把第一个链表的尾部连到第二个链表的头部，看是否形成一个环
    public boolean haveIntersectionNode(ListNode headA, ListNode headB){
        ListNode end1 = headA;
        ListNode end2 = headB;
